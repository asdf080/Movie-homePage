  ...
  return (
    <Layout>
      <div className='w-full'>
        ...
        <header className={`relative w-full h-[570px] flex justify-center text-white`}>
          ...
          <div className='w-[1300px] h-full py-[30px] px-10 flex'>
            <div className='w-[300px] h-[500px] bg-[#032541]'>
              <img src={`https://image.tmdb.org/t/p/w500${info.poster_path}` || "loading"} alt="img" />
        ...
        <section className='w-[1300px] h-full py-[30px] px-10 mx-auto'>
          ...
          <ul className='flex flex-wrap'>
            <li className='w-[280px] h-[100px] bg-red-200 m-2 mx-4 shadow-lg overflow-hidden rounded-lg flex'>
